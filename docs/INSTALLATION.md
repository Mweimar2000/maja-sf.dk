...
**Status: 8.1.8 installeret; publicering verificeres separat.** Et merge på GitHub deployer ikke koden til Apps Script; kun stilguiden hentes automatisk fra GitHub. Liveinstallationen af `8.1.8-validation` er bekræftet i den daterede [driftsstatus for 9. september 2026](VERIFIKATION.md#driftsstatus-9-september-2026).
