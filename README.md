...
**Status: 8.1.8 installeret; publicering verificeres separat.** Et GitHub-merge installerer ikke koden i Apps Script. Ved seneste kontrol gav PR #5 HTTP 404, fordi repositoryets Pull requests-funktion var slået fra. Den forberedende mergekontrol er dokumenteret i driftsstatus; den beviser ikke, at den endelige leverance er publiceret.
